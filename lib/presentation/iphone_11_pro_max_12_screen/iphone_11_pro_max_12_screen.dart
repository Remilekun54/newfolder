import '../iphone_11_pro_max_12_screen/widgets/listview8_item_widget.dart';
...
class Iphone11ProMax12Screen extends GetWidget<Iphone11ProMax12Controller> {
  @override
                                    ...
                                    child: Obx(
                                      () => ListView.builder(
                                        ...
                                        itemCount: controller
                                            .iphone11ProMax12ModelObj
                                            .value
                                            .listview8ItemList
                                            .length,
                                        itemBuilder: (context, index) {
                                          Listview8ItemModel model = controller
                                              .iphone11ProMax12ModelObj
                                              .value
                                              .listview8ItemList[index];
                                          return Listview8ItemWidget(
                                            model,
                                          );
                                        },
                                      ),
