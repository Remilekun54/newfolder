import '../iphone_11_pro_max_9_screen/widgets/listview11_item_widget.dart';
...
class Iphone11ProMax9Screen extends GetWidget<Iphone11ProMax9Controller> {
  @override
                                    ...
                                    child: Obx(
                                      () => ListView.builder(
                                        ...
                                        itemCount: controller
                                            .iphone11ProMax9ModelObj
                                            .value
                                            .listview11ItemList
                                            .length,
                                        itemBuilder: (context, index) {
                                          Listview11ItemModel model = controller
                                              .iphone11ProMax9ModelObj
                                              .value
                                              .listview11ItemList[index];
                                          return Listview11ItemWidget(
                                            model,
                                          );
                                        },
                                      ),
